...
public class Connectie 
{
    ...
    private static final  String MYSQL_DB="ID429726_g32";
	private static final  String MYSQL_USER="ID429726_g32";
	private static final String MYSQL_SERVER_URL = MYSQL_USER+".db.webhosting.be";
	private static final  String MYSQL_PWD="g32kingdomino";
    ...
    private final String SSH_SERVER_URL = "ssh.sdp1-g32.be", SSH_USER="sdp1-g32be";
